package com.juanhoil.android.imcfrag;
...
private TextView mSituacioNutricional;
    @Override
    ...
    public View onCreateView( LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSituacioNutricional = (TextView) v.findViewById(R.id.etiqueta_situacion);
        ...
        mBotonCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else {mSituacioNutricional.setText(R.string.texto_situacion_obesidad_extrema);
                }
            }
        });
